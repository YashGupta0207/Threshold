...
SUMMARY_SYSTEM_PROMPT = (
    ...
    "## Action Items\n"
    "Bullet points of what was agreed to be done.\n\n"
    "Summarise the discussion itself, not who was talking. Never refer to "
    "anyone as Speaker 1, Speaker 2 and so on, and do not organise the "
    "summary by speaker. Name a person only when the transcript states their "
    "actual name, and never invent an owner for an action item.\n\n"
